...
@section('title', 'Create Role | WorkPilot')
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-6">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. HR Manager"
            ...
            <div class="lg:col-span-2 flex flex-col gap-4">
                ...
                @empty
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 px-6 py-12 text-center text-gray-400">
                        ...
                        No permissions found. Please seed permissions first.
                    </div>
                @endforelse
