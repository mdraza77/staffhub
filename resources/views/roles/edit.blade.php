            ...
            <div class="lg:col-span-2 flex flex-col gap-4">
                ...
                @forelse ($permissions as $module => $perms)
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800 overflow-hidden">
                        ...
                        {{-- Module Header --}}
                        <div class="flex items-center justify-between px-5 py-3 bg-gray-50 dark:bg-zinc-950/50 border-b border-gray-100 dark:border-zinc-800">
                            <div class="flex items-center gap-2">
                                <div class="w-7 h-7 rounded-lg bg-indigo-50 dark:bg-indigo-950/30 flex items-center justify-center">
                                ...
                                <span class="text-xs text-gray-400 dark:text-zinc-500 font-normal">({{ $perms->count() }})</span>
                            </div>
                        ...
                        <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-3" id="module-{{ Str::slug($module) }}">
                            @foreach ($perms as $perm)
                                <label class="flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all group
                                                            {{ in_array($perm->name, old('permission', $rolePermissions)) ? 'border-blue-300 dark:border-blue-500/80 bg-blue-50 dark:bg-blue-950/30' : 'border-gray-100 dark:border-zinc-800 hover:border-blue-200 dark:hover:border-blue-500/50 hover:bg-blue-50 dark:hover:bg-blue-950/20' }}
                                                            has-[:checked]:border-blue-300 dark:has-[:checked]:border-blue-500/80 has-[:checked]:bg-blue-50 dark:has-[:checked]:bg-blue-950/30">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-700 dark:text-zinc-300 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">
